...
def main():
    parser = argparse.ArgumentParser(description="Train FusNet_legacy_1 for bamboo binary segmentation")
    parser.add_argument("--batch_size", type=int, default=24, help="Batch size")
    parser.add_argument("--epochs", type=int, default=120, help="Training epochs")
    parser.add_argument("--data_dir", type=str, default=".", help="Data root directory")
    parser.add_argument("--outchannel", type=int, default=2, help="Output channels (1 or 2)")
    ...
    try:
        ...
        raise ModuleNotFoundError(
            "Import FusNet_legacy_1 failed. Please ensure required dependencies are installed (for example `mamba_ssm`)."
        ) from exc
    ...
    output_dir = os.path.join("fusnet_legacy_1_outputs")
    ...
    model = FusNet(outchannel=args.outchannel).to(device)
