...
def main():
    parser = argparse.ArgumentParser(description="Train MambaVision baseline for bamboo binary segmentation")
    parser.add_argument("--batch_size", type=int, default=24)
    parser.add_argument("--epochs", type=int, default=120)
    parser.add_argument("--data_dir", type=str, default=".")
    parser.add_argument("--model_path", type=str,
                        default="./model/pretrained/mambavision_small_1k.pth.tar",
                        help="Path to MambaVision pretrained weights")
    ...
    output_dir = "mambavision_outputs"
    ...
    model = MambaVisionSeg(
        num_classes=2, pretrained=True, model_path=args.model_path
    ).to(device)
