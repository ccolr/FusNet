...
def main():
    parser = argparse.ArgumentParser(description="Train DeepLabV3 for bamboo binary segmentation")
    ...
    parser.add_argument("--arch", type=str, default="deeplabv3_resnet50",
                        choices=[
                            ...
                            "deeplabv3plus_resnet50", "deeplabv3plus_resnet101", "deeplabv3plus_mobilenet",
                        ],
                        help="DeepLab architecture")
    ...
    parser.add_argument("--no_pretrained_backbone", dest="pretrained_backbone",
                        action="store_false", help="Disable ImageNet-pretrained backbone")
    parser.add_argument("--pretrained_path", type=str, default=None,
                        help="Optional full DeepLabV3(+) checkpoint to warm-start from "
                             "(e.g. DeeplabV3/pretrained/best_deeplabv3_resnet50_voc_os16.pth)")
    parser.add_argument("--encoder_lr", type=float, default=1e-5,
                        help="LR for the (pretrained) backbone")
    parser.add_argument("--decoder_lr", type=float, default=1e-4,
                        help="LR for the classifier head")
    ...
    output_dir = os.path.join("deeplabv3_outputs")
    ...
    optimizer = torch.optim.AdamW([
        {"params": list(model.encoder_parameters()), "lr": args.encoder_lr},  # 预训练backbone用小lr
        {"params": list(model.decoder_parameters()), "lr": args.decoder_lr},  # 新模块用大lr
    ], weight_decay=1e-4)
